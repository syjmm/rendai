    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <a href="https://www.cdkhd.com:8443/api/manager/opinions/export">
                    <el-button type="success" icon="search">导出</el-button>
                </a>

            </div>
            <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                <el-table-column prop="createAt" label="提出时间" width="220" align="center">
                </el-table-column>
                <el-table-column prop="sender" label="提出人" width="220" align="center">
                </el-table-column>
                <el-table-column prop="anonymous" label="是否匿名"  width="220" align="center">
                    <template slot-scope="scope">
                        <div v-if="scope.row.anonymous == true">是</div>
                        <div v-if="scope.row.anonymous == false">否</div>
                    </template>
                </el-table-column>
                <el-table-column prop="receiver" label="接受代表"  width="220" align="center">
                </el-table-column>
                <el-table-column prop="replied" label="是否回复" width="220" align="center">
                    <template slot-scope="scope">
                        <div v-if="scope.row.replied == true">是</div>
                        <div v-if="scope.row.replied == false">否</div>
                    </template>
                </el-table-column>
                <el-table-column prop="status" label="是否处理" align="center">
                    <template slot-scope="scope">
