            ...
            <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="操作" width="280" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button size="small"  v-if="scope.row.audit == '0' || scope.row.audit == '1'" type="danger" @click="handleEdit(scope.$index, scope.row)">审核不通过</el-button>
                    </template>
                </el-table-column>
            </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            shenhe(index, row){
                ...
                this.pass=true;
                let token = localStorage.getItem('ms_token');
                this.$axios.post('/manager/jobs/audit',
                qs.stringify({
                    pass:this.pass,
                    uid:this.sid
                },{
